...
var baotrongit = {
  ...
  chuanghiduoc = {
    grace_period_expires_date: null,
    purchase_date: "2024-09-02T01:04:17Z",
    product_identifier: "com.baotrongit.premium.yearly",
    expires_date: "2099-12-18T01:04:17Z",
  };
...
if (match) {
  ...
  s
    ? ((chuanghiduoc.product_identifier = s),
      (obj.subscriber.subscriptions[s] = baotrongit))
    : (obj.subscriber.subscriptions["com.baotrongit.premium.yearly"] =
        baotrongit),
    (obj.subscriber.entitlements[e] = chuanghiduoc);
} else
  (obj.subscriber.subscriptions["com.baotrongit.premium.yearly"] = baotrongit),
    (obj.subscriber.entitlements.pro = chuanghiduoc);
